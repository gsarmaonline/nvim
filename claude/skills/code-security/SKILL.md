...
**Audited By:** /code-security skill
...
*This report was generated automatically by the /code-security skill. Manual review is recommended for complex logic vulnerabilities.*
```
...
- Use the `/code-security` skill to scan for vulnerabilities before major releases or when adding new API endpoints
- Run `/code-security` after adding new dependencies to check for known CVEs
