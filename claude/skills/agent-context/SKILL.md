...
2. **Parse user input**: The user will provide information after the command (e.g., "/agent-context should run puppeteer")
...
User: `/agent-context should run puppeteer`
Action: Add "- Should run puppeteer" under "Commands and Tools"

User: `/agent-context requires Node.js 18+`
Action: Add "- Requires Node.js 18+" under "Requirements"

User: `/agent-context this is a vim configuration repo`
