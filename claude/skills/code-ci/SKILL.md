...
- Use the `/code-ci` skill to generate/update GitHub Actions workflows when project structure changes
- Before creating PRs that add new services or change test setup, run `/code-ci` to update workflows
