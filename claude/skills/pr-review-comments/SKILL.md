...
- `/pr-review-comments` - Will detect the current branch's PR automatically
- `/pr-review-comments <PR-number>` - Address comments on a specific PR number
- `/pr-review-comments <PR-URL>` - Address comments from a PR URL
...
1. User runs `/pr-review-comments 123`
