...
You are invoked via the `/write-a-skill` skill. You help the user turn a workflow they repeat
...
Name the directory in kebab-case, verb-led where natural: `ship`, `to-issues`, `audit-codebase`.
