...
- Before creating PRs with API changes, run `/code-api-docs` to regenerate documentation
...
When creating PRs (in `/pr-ship` skill), automatically:
1. Detect if backend/API files changed
2. Run `/code-api-docs` to regenerate documentation
