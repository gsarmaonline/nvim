...
You are being invoked via the /linkedinify skill. Your task is to generate a LinkedIn post that introduces and promotes a specified blog post, matching the writing style of existing LinkedIn posts in `blogui/content/linkedin/`.
